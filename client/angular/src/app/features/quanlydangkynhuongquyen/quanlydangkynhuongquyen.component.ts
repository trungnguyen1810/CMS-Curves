...
import {DangKyNhuongQuyenService} from './service/dangkynhuongquyen.service';

import { NgbModal } from '@ng-bootstrap/ng-bootstrap';
import { Table } from 'primeng/table';
import { convertDateObjToYMD } from './../../core/utils/common-functions';
@Component({
  selector: 'app-quanlydangkynhuongquyen',
  templateUrl: './quanlydangkynhuongquyen.component.html',
  styleUrls: ['./quanlydangkynhuongquyen.component.css']
})
export class QuanlydangkynhuongquyenComponent implements OnInit {
  donhangs:any=[];
  statuses: any[];
  TuNgay:any = null;
  DenNgay:any= new Date();
  @ViewChild('dt') table: Table;
  constructor(private readonly service: DangKyNhuongQuyenService,private modalService: NgbModal) { }
  ...
  async delete(donhang){
    ...
    var r = confirm("Bạn có chắc muốn xóa đăng ký nhượng quyền này không ?");
    if (r == true) {
  ...
  async XuLy(donhang){
    var r = confirm("Bạn có chắc muốn xử lý đăng ký nhượng quyền này không ?");
    if (r == true) {
