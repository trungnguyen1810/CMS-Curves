...
@Component({
  selector: 'app-themmoitonkho',
  templateUrl: './themmoi.component.html',
  providers: [MessageService]
})

export class ThemmoiTonKhoComponent implements OnInit {
  ...
  checkIsclb :any = [];
  Isclb: boolean = false;
  constructor(public activeModal: NgbActiveModal, private sanphamservice: QuanLyTonKhoService, private messageService: MessageService,private primengConfig: PrimeNGConfig) {
  ...
  bindDataEdit() {
    ...
    this.showImg = true;
    this.Gia = this.data.sanpham.Gia;
