...
@Component({
  selector: 'app-in-xac-nhan',
  templateUrl: './inxacnhan.component.html',
  providers: [DialogService]
})

export class InXacNhanComponent implements OnInit, OnDestroy {
  @Input() OBJ;
  ...
  ngOnInit() {
    ...
    this.Ten = this.OBJ.HoVaTen;
    this.NgayHetHan = this.OBJ.HanSuDung;
    this.SDT = this.OBJ.SoDienThoai;
    this.SoNgay = this.OBJ.SoNgayHoanTra;
    this.SoTien = this.OBJ.SoTienHoanTra;
    this.Voucher = this.OBJ.MaVouCher;
